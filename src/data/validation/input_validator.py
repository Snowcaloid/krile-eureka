...
class InputValidator:
    ...
    async def check_valid_raid_leader(self, interaction: Interaction, member: Member, event_type: str) -> bool:
        allow_ba, allow_drs, allow_bozja, allow_chaotic, allow_oc = PermissionValidator.get_raid_leader_permissions(member)
        ...
        result = result or (event_base.category() == EventCategory.OC and allow_oc)
