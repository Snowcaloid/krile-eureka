    ...
    def sync(self, channel: ChannelStruct,
        ...
        with context:
            ...
            if found_channel:
                ...
                context.log(f"[CHANNELS] #{self._bot.client.get_channel(edited_channel.channel_id).name} updated successfully.")
                ...
                context.log(f"[CHANNELS] #{self._bot.client.get_channel(channel.channel_id).name} added successfully.")
